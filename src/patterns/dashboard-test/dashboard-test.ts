...
/**
 * DashboardTest Navigation Pattern
 * A reusable navigation pattern using Cre8-Components
 */
@customElement('dashboard-test-navigation')
export class DashboardTestNavigation extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'dashboard-test-navigation': DashboardTestNavigation;
  }
}
