...
/**
 * UserForm Form Pattern
 * A reusable form pattern using Cre8-Components
 */
@customElement('user-form-form')
export class UserFormForm extends LitElement {
    ...
    return html`
      <div class="form-wrapper">
        <form @submit="${this.handleSubmit}">
          ...
          <div class="form-section">
            <cre8-field label="Full Name" required .error="${this.errors.name}">
              <input
                type="text"
                name="name"
          ...
          <div class="form-section">
            <cre8-field label="Email" required .error="${this.errors.email}">
              <input
                type="email"
                name="email"
                @input="${this.handleInput}"
          ...
          <div class="form-section">
            <cre8-checkbox-field name="subscribe" @change="${this.handleInput}">
